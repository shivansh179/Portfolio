...
const CallToAction = () => {
  ...
  return (
   <div className="call-to-action flex flex-col items-center justify-center h-80 bg-gray-800 w-full bg-cover bg-center relative " style={{ backgroundImage: `url(${logo})` , borderRadius:20}}>
